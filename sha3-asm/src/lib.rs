...
extern "C" {
    ...
    ///                    size_t r);
    /// ```
    pub fn KECCAK_ASM_SHA3_absorb(a: *mut Buffer, inp: *const u8, len: usize, r: usize) -> usize;
